                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 border-t border-gray-100 dark:border-gray-700 pt-6">
                            ...
                            <p class="text-xs text-gray-400 mb-4">Tambahkan rekening M-Banking Anda agar Admin dapat mencairkan/mentransfer dana hasil penjualan kepada Anda setelah pembeli mengonfirmasi penerimaan barang.</p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="atas_nama" id="atas_nama" value="{{ old('atas_nama') }}" placeholder="Contoh: Budi Santoso" class="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 dark:bg-gray-900 dark:border-gray-700 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-gray-800 dark:text-gray-200">
                                    @error('atas_nama')
                                        <p class="text-sm text-rose-500 mt-2">{{ $message }}</p>
                                    @enderror
                                </div>
