                ...
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 border-t border-gray-100 dark:border-gray-700 pt-6">
                            ...
                            <p class="text-xs text-gray-400 mb-4">Tambahkan rekening M-Banking Anda agar pembeli dapat mentransfer langsung ke rekening ini saat memesan produk ini.</p>
